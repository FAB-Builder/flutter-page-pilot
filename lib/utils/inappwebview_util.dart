...
//   static handleOnPageLoad(InAppWebViewController c) async {
//     try {
...
//       final jsResult =
//           await c!.evaluateJavascript(source: calculateHtmlDocDimensions);
...
//       final pixelRatioJs =
//           await c!.evaluateJavascript(source: 'window.devicePixelRatio');
...
//       sizeNotifier.value = {"height": adjustedHeight, "width": adjustedWidth};
...
//   static InAppWebViewController init({required bool isTour}) {
...
//     return InAppWebView(
//       onLoadStop: (cntler, url) {
//         controller = cntler;

//         handleOnPageLoad(cntler);
//       },
//     );
//   }
...
//       {InAppWebViewController? tourWebViewController}) {
...
//                     width: size["width"],
//                     child: InAppWebView(
//                       onWebViewCreated: (cntler) {
//                         if (tourWebViewController != null)
//                           tourWebViewController = cntler;
//                         else
//                           controller = cntler;
//                       },
//                       onLoadStop: (cntler, url) {
...
//           final messageJsonString = args[0].toString();
...
//     URLRequest urlRequest = URLRequest(url: WebUri.uri(Uri.parse(url)));
