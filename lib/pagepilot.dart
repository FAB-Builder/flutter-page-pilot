...
export 'package:pagepilot/pagepilot_initiaze.dart';
export 'package:pagepilot/src/target/target_content.dart';
export 'package:pagepilot/src/target/target_focus.dart';
export 'package:pagepilot/src/target/target_position.dart';
export 'package:pagepilot/src/util.dart';
...
class PagePilot {
  ...
  final GlobalKey<PagePilotWidgetState> _widgetKey = GlobalKey();
