...
import 'package:pagepilot/src/target/target_content.dart';
import 'package:pagepilot/src/target/target_focus.dart';
import 'package:pagepilot/src/target/target_position.dart';
import 'package:pagepilot/src/util.dart';
import 'package:pagepilot/src/widgets/animated_focus_light.dart';

class PagePilotWidget extends StatefulWidget {
  const PagePilotWidget({
    Key? key,
  ...
  @override
  PagePilotWidgetState createState() => PagePilotWidgetState();
}

class PagePilotWidgetState extends State<PagePilotWidget>
    implements PagePilotController {
