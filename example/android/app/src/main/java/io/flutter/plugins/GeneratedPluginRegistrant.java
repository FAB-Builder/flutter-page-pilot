...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.fabbuilder.pagepilot.PagePilotPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin pagepilot, com.fabbuilder.pagepilot.PagePilotPlugin", e);
    }
    try {
